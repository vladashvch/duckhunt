...
class GameObj():
    ...
    Methods:
        ...
        draw(): Draws the object on the screen, based on values given to object when created it.
    """
    ...
    def draw(self):
        """
        Draws the object on the screen, based on values given to object when created it. Rescaling image to object's width and height.
        """
